export _REPOSITORY_NAME="PR0003_rosalbita_production"
export _PROJECT_NAME="ProjectRosalbitaCo"
export _PATH="/docker/compose/"
export COMPOSE_PROJECT_NAME= $_REPOSITORY_NAME
export _REF_REPOSITORY="https://github.com/Xiomarasheck/ProjectRosalbitaCo.git"
...
if [ -d $_PATH$_PROJECT_NAME/$_REPOSITORY_NAME/volumes/_mysql-data ];
  then
    echo "Directory postgis OK"
  else
    mkdir $_PATH$_PROJECT_NAME/$_REPOSITORY_NAME/volumes/_mysql-data
